...
<sml:SensorML xmlns:sml="http://www.opengis.net/sensorML/1.0.1" xmlns:swe="http://www.opengis.net/swe/1.0.1" xmlns:gml="http://www.opengis.net/gml" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0.1">
  <sml:member>
        ...
        <swe:DataRecord>
          ...
          <swe:field name="descriptif_capteur">
            <swe:Text definition="http://shom.fr/maregraphie/descriptif_capteur">
              <swe:value>https://refmar.shom.fr/maregraphe-radar-ondes-guidees-bm100a</swe:value>
            </swe:Text>
          </swe:field>
          <swe:field name="collocalisation">
            <swe:Text definition="http://shom.fr/maregraphie/collocalisation">
              <swe:value>https://www.sonel.org/?page=gps&amp;idStation=642</swe:value>
            </swe:Text>
          </swe:field>
          ...
          <swe:field name="info_maregraphe">
            <swe:Text definition="http://shom.fr/maregraphie/info_maregraphe">
              <swe:value>https://refmar.shom.fr/donnees/3</swe:value>
            </swe:Text>
          </swe:field>
        ...
        <swe:DataRecord definition="http://shom.fr/maregraphie/organisme">
          ...
          <swe:field name="Marine nationale">
            <swe:DataRecord definition="http://shom.fr/maregraphie/organisme">
              ...
              <swe:field name="URL">
                <swe:Text definition="http://shom.fr/maregraphie/lien">
                  <swe:value>https://www.defense.gouv.fr/marine</swe:value>
                </swe:Text>
              </swe:field>
            </swe:DataRecord>
          </swe:field>
	...
	Les données validées jusqu&apos;au 10/01/2011 sont disponibles sur le serveur FTP
          ...
          <sml:member name="logbook-2009-12-02">
            <sml:Event>
	...
	Relance du MCN. Archivage des données.
          ...
          <sml:member name="logbook-2010-02-16">
            <sml:Event>
	...
	Relance du MCN. Archivage des données.
          ...
          <sml:member name="logbook-2012-05-04">
            <sml:Event>
	...
	Moyenne des écarts entre la sonde et le MCN : 0.13cm (écart type : 0.04).</gml:description>
          ...
          <sml:member name="logbook-2011-06-16">
            <sml:Event>
	...
	Les données validées jusqu&apos;au 30 mai 2011 sont disponibles sur le serveur FTP.
          ...
          <sml:member name="logbook-2013-07-25">
            <sml:Event>
	...
	Moyenne des écarts à PM : -0.43 cm (écart type : 0.06 cm)
          ...
          <sml:member name="logbook-2002-11-26">
            <sml:Event>
	...
	Le capteur radar BM70 est remplacé par un capteur BM100 (toujours Krohne).
          ...
          <sml:member name="logbook-2011-03-24">
            <sml:Event>
	...
	Relance du MCN. Archivage des données à 10min et HH.
          ...
          <sml:member name="logbook-2011-04-07">
            <sml:Event>
	...
	Contrôle de la sonde lumineuse. Les résultats sont très satisfaisants.
          ...
          <sml:member name="logbook-2009-10-22">
            <sml:Event>
	...
	Suite à un test de Van de Cateele réalisé semaine 43, de nouveaux coefficients a1 et b1 de correction ont été calculés et entrés dans la centrale du MCN de Brest.
          ...
          <sml:member name="logbook-2013-07-23">
            <sml:Event>
	...
	Plantage du MCN. Données aberrantes (supprimées dans les validées au prochain archivage d&apos;octobre).
          ...
          <sml:member name="logbook-2013-07-11">
            <sml:Event>
	...
	La côte entrée le 25/04 était plus haute d&apos;un centimètre. Modification des données du 25/04 au 11/07 dans les validées à 10 min (seront disponible au prochain archivage d&apos;octobre).</gml:description>
          ...
          <sml:member name="logbook-2000-05-29">
            <sml:Event>
	...
	Mise en place d&apos;un afficheur indiquant la hauteur d&apos;eau enregistrée par le marégraphe au dessus de la porte du marégraphe.
          ...
          <sml:member name="logbook-2008-06-26">
            <sml:Event>
	...
	Remplacement du prototype par une nouvelle centrale ELTA.
          ...
          <sml:member name="logbook-1993-02-05">
            <sml:Event>
	...
	Un premier marégraphe côtier numérique (MCN) est installé à Brest le 05/02/1993: capteur ultrason IEE et centrale d&apos;acquisition MORS HT200.
          ...
          <sml:member name="logbook-2000-10-01">
            <sml:Event>
	...
	Installation d&apos;un marégraphe radar: capteur BM70 et d&apos;une centrale d&apos;acquisition Elta. A noter que le marégraphe ultrason continue à enregistrer.
          ...
          <sml:member name="logbook-2014-10-09">
            <sml:Event>
	...
	Moyenne des écarts à BM : 0.45 cm (écart type : 0.12 cm)
          ...
          <sml:member name="logbook-2024-09-18">
            <sml:Event>
              <sml:date>2024-10-07T11:51:21.000Z</sml:date>
              <gml:description>Nettoyage du câble guide-onde du capteur radar optiflex.</gml:description>
            </sml:Event>
          </sml:member>
          <sml:member name="logbook-2015-11-26">
            <sml:Event>
          ...
          <sml:member name="logbook-2016-01-12">
            <sml:Event>
...
Pas d&apos;explication pour le moment pour les mauvais résultats du mois de novembre.</gml:description>
          ...
          <sml:member name="logbook-2016-02-11">
            <sml:Event>
...
Moyenne des écarts à PM : 0.18 cm (écart type : 0 cm).</gml:description>
          ...
          <sml:member name="logbook-2016-11-18">
            <sml:Event>
          ...
          <sml:member name="logbook-2018-07-23">
            <sml:Event>
          ...
          <sml:member name="logbook-2019-10-03">
            <sml:Event>
          ...
          <sml:member name="logbook-2020-01-02">
            <sml:Event>
          ...
          <sml:member name="logbook-2020-05-25">
            <sml:Event>
          ...
          <sml:member name="logbook-2020-03-25">
            <sml:Event>
          ...
          <sml:member name="logbook-2020-05-27">
            <sml:Event>
          ...
          <sml:member name="logbook-2020-10-13">
            <sml:Event>
          ...
          <sml:member name="logbook-2021-09-13">
            <sml:Event>
          ...
          <sml:member name="logbook-2024-06-20">
            <sml:Event>
              <sml:date>2024-06-20T11:31:17.000Z</sml:date>
              <gml:description>Investigations en cours.</gml:description>
            </sml:Event>
          </sml:member>
          <sml:member name="logbook-2024-06-21">
            <sml:Event>
              <sml:date>2024-06-21T11:05:33.000Z</sml:date>
              <gml:description>Alimentation interne redisposée.</gml:description>
            </sml:Event>
          </sml:member>
          <sml:member name="logbook-2024-11-14">
            <sml:Event>
              <sml:date>2024-11-25T11:30:35.000Z</sml:date>
              <gml:description>Fonctionnement à nouveau nominal de la diffusion des données après le nettoyage des branchements et du changement d&apos;&apos;un câble réseau.</gml:description>
            </sml:Event>
          </sml:member>
          <sml:member name="logbook-2024-12-17">
            <sml:Event>
              <sml:date>2024-12-19T10:17:00.000Z</sml:date>
              <gml:description>Installation d&apos;&apos;une nouvelle centrale d&apos;&apos;acquisition</gml:description>
            </sml:Event>
          </sml:member>
          <sml:member name="logbook-2024-09-19">
            <sml:Event>
              <sml:date>2024-10-07T11:51:51.000Z</sml:date>
              <gml:description>Calibration du capteur de niveau radar.
L&apos;&apos;intercomparaison des mesures à l&apos;&apos;intérieur et extérieur du puits confirme que le puits n&apos;&apos;est pas obstrué.</gml:description>
            </sml:Event>
          </sml:member>
          <sml:member name="logbook-2024-11-02">
            <sml:Event>
              <sml:date>2024-11-05T09:19:11.000Z</sml:date>
              <gml:description>Accès impossible à la centrale d&apos;&apos;acquisition. Suspicion d&apos;&apos;un problème au niveau de l&apos;&apos;antenne de transmission.</gml:description>
            </sml:Event>
          </sml:member>
